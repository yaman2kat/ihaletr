...
// kendi paneli DEĞİL). "Beklemede" (admin onayı bekleyen) rozeti burada
// KASITLI OLARAK hiç gösterilmez -- genel listede zaten yalnızca
// onaylanmış ihaleler görünür (inceleme_durumu='onaylandi' filtresi),
// onay bekleyen durumu yalnızca sahibinin kendi panelinde
// "İnceleme Aşamasında" olarak görünür (bkz. ArsaSahibiPanel.tsx).
// - İptal: sabit rozet.
// - Süresi henüz dolmamış: geri sayım (3 günden az turuncu, aksi yeşil).
// - Süresi dolmuş (tamamlandi ya da bitis_tarihi gecmis) AMA kazanan
...
export default function IhaleKarti({ ihale }: Props) {
