...
export default function OdemeFormu({ paket, sandboxMi }: { paket: string; sandboxMi: boolean }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center px-4 pt-16 pb-24">
      <div className="w-full max-w-md">
        ...
        {/* Sandbox test kartları -- yalnizca IYZICO_BASE_URL sandbox
            iken gosterilir; canliya gecince (api.iyzipay.com) hic
            render edilmez, gercek kullanicilar test karti panelini
            hic gormez. */}
        {sandboxMi && (
